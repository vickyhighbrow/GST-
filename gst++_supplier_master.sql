...
CREATE TABLE `supplier_master` (
  ...
  KEY `ORG_ID_SM_idx` (`ORG_ID`),
  CONSTRAINT `ORG_ID_SM` FOREIGN KEY (`ORG_ID`) REFERENCES `org_master` (`ORG_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Supplier Master';
