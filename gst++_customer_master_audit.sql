...
--
-- Table structure for table `customer_master_audit`
--

DROP TABLE IF EXISTS `customer_master_audit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `customer_master_audit` (
  ...
  PRIMARY KEY (`ID`),
  KEY `ORG_ID_MA` (`ORG_ID`),
  CONSTRAINT `ORG_ID_MA` FOREIGN KEY (`ORG_ID`) REFERENCES `org_master` (`ORG_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Customer Master Audit';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `customer_master_audit`
--

LOCK TABLES `customer_master_audit` WRITE;
/*!40000 ALTER TABLE `customer_master_audit` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_master_audit` ENABLE KEYS */;
UNLOCK TABLES;
